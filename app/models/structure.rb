class Structure < ActiveRecord::Base
  ...
  has_attached_file :sv_logo, :styles => { :small => "180x180#", :thumb => "70x70#" }, path: ":rails_root/public/system/:attachment/:id/:style/:filename",url: "/system/:attachment/:id/:style/:filename"
